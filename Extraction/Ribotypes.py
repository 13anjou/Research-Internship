...
def binning(nod,k) : #On fait le binning
	...
	return log1,taille1,rang1,stationNoms
...
def analyse_data (log_abondances, tailles, nod,k,rang,sN,dictionnaire) :
	...
	from algo_lineaire_final import* #L'algorithme de decoupage
	indice = -1
	sN2=list()
	longueurs = list()
	poids = list()
...
def lancement(k) : 
	...
	log_abondances, tailles,rang,stationNoms = binning(noms,k) #On recupere le binning
	...
	xticks(arange(len(noms1)),noms1,rotation=90,fontsize=30)
	...
	plt.title('avant derniere pentes (2)',fontsize=30)
	plt.legend()
	yticks(fontsize=30)
	xticks(fontsize=30)
	...
	plt.figure(figsize=(20,40./3.))
	xticks(arange(len(noms2)),noms2,rotation=90,fontsize=30)
	...
	for dot in pentes2 :
		...
		indice = indice + 1
	plt.title('derniere pentes (1)',fontsize=30)
	plt.legend()
	yticks(fontsize=30)
	xticks(fontsize=30)
	plt.xlabel("Station", fontsize=30)
	...
	plt.figure(figsize=(20,40./3.))
	xticks(arange(len(noms3)),noms3,rotation=90,fontsize=30)
	...
	plt.title('Pentes uniques',fontsize=30)
	plt.legend()
	yticks(fontsize=30)
	xticks(fontsize=30)
	plt.xlabel("Station", fontsize=30)
	plt.ylabel("Slope", fontsize=30)
	plt.title('Rank/abundance slopes',fontsize = 40)
	...
	plt.figure(figsize=(20,40./3.))
	xticks(arange(len(liste_stations)),liste_stations,rotation=90,fontsize=30)
	...
	plt.title('Toutes pentes et tailles confondues',fontsize=30)
	plt.legend()
	yticks(fontsize=30)
	xticks(fontsize=30)
	plt.xlabel("Station", fontsize=30)
	...
	plt.title('Fraction de taille : 0.8 a 5',fontsize=30)
	plt.legend()
	yticks(fontsize=30)
	xticks(fontsize=30)
	plt.xlabel("Station", fontsize=30)
	...
	plt.title('Fraction de taille : 180 a 2000',fontsize=30)
	plt.legend()
	yticks(fontsize=30)
	xticks(fontsize=30)
	plt.xlabel("Station", fontsize=30)
	...
	plt.title('Fraction de taille : 20 a 180',fontsize=30)
	plt.legend()
	yticks(fontsize=30)
	xticks(fontsize=30)
	plt.xlabel("Station", fontsize=30)
	...
	plt.title('Fraction de taille : 5 a 20',fontsize=30)
	plt.legend()
	yticks(fontsize=30)
	xticks(fontsize=30)
	plt.xlabel("Station", fontsize=30)
