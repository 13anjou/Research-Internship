...
def main() :
	...
	for clef in dicoTotal :
		...
		if l2 < 39 :
			#print("perte de donnees sur l'echantillon' {}".format(clef[0]))
			dicoTotal[clef] = dicoTotal[clef] + ['nan']*(39-l2)
...
def tracer(a, b) :	 #Quand on veut juste placer pour chaque stattion un parametre en fonction d'un autre. 
	...
	18: 'lat_origin_45d',19 :'physat_type',20 : 'abundance',21: 'richness',22 : 'Shannon',23: 'Simpson',24 :'log(alpha)',25 : 'Evenness',26 :'S.obs',27 :'S.chao1',28 : 'se.chao1',
...
def sortie() :
	...
	with open('C:\\Users\\valentin\Desktop\\boulot_mines\\S3Recherche\\Resultats\\DataMatrix.csv', 'wb') as csvfile:
		chaine = list()
		writer = csv.writer(csvfile, delimiter=',',quotechar='|', quoting=csv.QUOTE_MINIMAL)
		writer.writerow(['station','taille','echantillon','u','v','Okubo Weiss', 'Lyapunov exp', 'SST_adv','SST_AMSRE','gradt_SST_adv','age_from_bathy','lon_from_bathy','Shannon_Darwin_mean_all','Shannon_Darwin_month_all','Shannon_Darwin_mean_grp','Shannon_Darwin_month_grp','Shannon_Darwin_physat_month','Shannon_Darwin_physat_mean','Shannon_Darwin_retention','lon_origin_45d,lat_origin_45d','physat_type','abundance','richness','Sahnnon','Simpson','log(alpha)','Eveness','S.obs','S.chao1','se.chao1','S.ACE','se.ACE','difference avec la power-law','nb de pentes','dernière pente','avant-dernière pente','longueur de la dernière pente',' longueur de l avant dernière pente',' poids de la dernière pente',' poids de l avant derniere pente'])
		for echantillon in d :
			chaine = [echantillon[0],echantillon[1]]
			for i in d[echantillon] :
				chaine += [i]
			try :
				writer.writerow(float(chaine))
			except :
				writer.writerow(chaine)
				pass

	print('echo1')
	with open('C:\\Users\\valentin\Desktop\\boulot_mines\\S3Recherche\\Resultats\\DataMatrix_0.5.csv', 'wb') as csvfile:
		chaine = list()
		writer = csv.writer(csvfile, delimiter=',',quotechar='|', quoting=csv.QUOTE_MINIMAL)
		writer.writerow(['station','taille','echantillon','u','v','Okubo Weiss', 'Lyapunov exp', 'SST_adv','SST_AMSRE','gradt_SST_adv','age_from_bathy','lon_from_bathy','Shannon_Darwin_mean_all','Shannon_Darwin_month_all','Shannon_Darwin_mean_grp','Shannon_Darwin_month_grp','Shannon_Darwin_physat_month','Shannon_Darwin_physat_mean','Shannon_Darwin_retention','lon_origin_45d,lat_origin_45d','physat_type','abundance','richness','Sahnnon','Simpson','log(alpha)','Eveness','S.obs','S.chao1','se.chao1','S.ACE','se.ACE','difference avec la power-law','nb de pentes','dernière pente','avant-dernière pente','longueur de la dernière pente',' longueur de l avant dernière pente',' poids de la dernière pente',' poids de l avant derniere pente'])
		for echantillon in d :
	...
	with open('C:\\Users\\valentin\Desktop\\boulot_mines\\S3Recherche\\Resultats\\DataMatrix_180.csv', 'wb') as csvfile:
		chaine = list()
		writer = csv.writer(csvfile, delimiter=',',quotechar='|', quoting=csv.QUOTE_MINIMAL)
		writer.writerow(['station','taille','echantillon','u','v','Okubo Weiss', 'Lyapunov exp', 'SST_adv','SST_AMSRE','gradt_SST_adv','age_from_bathy','lon_from_bathy','Shannon_Darwin_mean_all','Shannon_Darwin_month_all','Shannon_Darwin_mean_grp','Shannon_Darwin_month_grp','Shannon_Darwin_physat_month','Shannon_Darwin_physat_mean','Shannon_Darwin_retention','lon_origin_45d,lat_origin_45d','physat_type','abundance','richness','Sahnnon','Simpson','log(alpha)','Eveness','S.obs','S.chao1','se.chao1','S.ACE','se.ACE','difference avec la power-law','nb de pentes','dernière pente','avant-dernière pente','longueur de la dernière pente',' longueur de l avant dernière pente',' poids de la dernière pente',' poids de l avant derniere pente'])
		for echantillon in d :
			if echantillon[1]==180 :
				chaine = [echantillon[0],echantillon[1]]
				for i in d[echantillon] :
					chaine += [i]
				try :
	...
	with open('C:\\Users\\valentin\Desktop\\boulot_mines\\S3Recherche\\Resultats\\DataMatrix_20.csv', 'wb') as csvfile:
		chaine = list()
		writer = csv.writer(csvfile, delimiter=',',quotechar='|', quoting=csv.QUOTE_MINIMAL)
		writer.writerow(['station','taille','echantillon','u','v','Okubo Weiss', 'Lyapunov exp', 'SST_adv','SST_AMSRE','gradt_SST_adv','age_from_bathy','lon_from_bathy','Shannon_Darwin_mean_all','Shannon_Darwin_month_all','Shannon_Darwin_mean_grp','Shannon_Darwin_month_grp','Shannon_Darwin_physat_month','Shannon_Darwin_physat_mean','Shannon_Darwin_retention','lon_origin_45d,lat_origin_45d','physat_type','abundance','richness','Sahnnon','Simpson','log(alpha)','Eveness','S.obs','S.chao1','se.chao1','S.ACE','se.ACE','difference avec la power-law','nb de pentes','dernière pente','avant-dernière pente','longueur de la dernière pente',' longueur de l avant dernière pente',' poids de la dernière pente',' poids de l avant derniere pente'])
		for echantillon in d :
	...
	with open('C:\\Users\\valentin\Desktop\\boulot_mines\\S3Recherche\\Resultats\\DataMatrix_2000csv', 'wb') as csvfile:
		chaine = list()
		writer = csv.writer(csvfile, delimiter=',',quotechar='|', quoting=csv.QUOTE_MINIMAL)
		writer.writerow(['station','taille','echantillon','u','v','Okubo Weiss', 'Lyapunov exp', 'SST_adv','SST_AMSRE','gradt_SST_adv','age_from_bathy','lon_from_bathy','Shannon_Darwin_mean_all','Shannon_Darwin_month_all','Shannon_Darwin_mean_grp','Shannon_Darwin_month_grp','Shannon_Darwin_physat_month','Shannon_Darwin_physat_mean','Shannon_Darwin_retention','lon_origin_45d,lat_origin_45d','physat_type','abundance','richness','Sahnnon','Simpson','log(alpha)','Eveness','S.obs','S.chao1','se.chao1','S.ACE','se.ACE','difference avec la power-law','nb de pentes','dernière pente','avant-dernière pente','longueur de la dernière pente',' longueur de l avant dernière pente',' poids de la dernière pente',' poids de l avant derniere pente'])
		for echantillon in d :
			if echantillon[1]==2000 :
				chaine = [echantillon[0],echantillon[1]]
				for i in d[echantillon] :
					chaine += [i]
				try :
